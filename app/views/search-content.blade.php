<div class="insidesearchbox">
		...
		<form action="#" id="mainSearchDarsPanel" class="searchdarsform" onsubmit="do_search(document.getElementById('searchContentInput').value, '{{ $teacher }}', '{{ $lesson }}', '{{ $year }}');return false;">
		<div>
