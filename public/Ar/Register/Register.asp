...
function Login(){
	  ...
	  Response.write('<tr>');
          Response.write('<TD colspan="2" class="register-td" ><p>لتعديل وتصحيح بياناتك يرجى الدخول باستخدام الاسم وكلمة السر</p></TD>');
          Response.write('</tr>');
...
//          Response.write('</tr>');
          ...
          Response.write('<tr>');
          Response.write('<td class="register-td2">اسم المستخدم</td>');
          Response.write('<td class="register-td3"><INPUT dir=ltr Required=true></td>');
          Response.write('</tr>');
		  
          Response.write('<tr>');
          Response.write('<td class="register-td2">كلمة السر</td> ');
          ...
          Response.write('</tr>');
          Response.write('<td colspan="2" class="register-td4"><input type="submit" value=" دخول " name="B1" ></td>');
          Response.write('</tr>');
...
//                          UserId=null;   
          ...
          Response.write('<tr>');
          Response.write('<td valign="top" align ="center" dir=rtl class="register-td">ملاحظة: اسم المستخدم يجب ان يكون بالحروف الانجليزية و يفضل ان يتكون من الحرف الاول من الاسم الاول مضافة الى الاسم الاخير ( مثال: محمد حسيني،ـ m_hoseini )</td>');
		  Response.write('</tr>');
		  Response.write('<tr>');
		  Response.write('<td valign="top" align ="Right" dir=rtl>&nbsp;</td>');
		  Response.write('</tr>');
		  Response.write('<tr>');
		  Response.write('<td valign="top" align ="center" dir=rtl class="register-td"><Font color="#f1a664"><strong>ملاحظة: سوف يجمّد حسابك لو قمت بادخال بيانات خاطئة</strong></font></td>');
          Response.write('</tr>');
		  Response.write('<tr>');
		  Response.write('<td valign="top" align ="Right" dir=rtl>&nbsp;</td>');
		  Response.write('</tr>');
          ...
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;اسم المستخدم:</TD>');
          if(State=='NewProfile')
          Response.write('	    <TD class="register-td3"><INPUT maxLength=20 title="اسم المستخدم" name=eUserName size=20 dir=ltr Value="'+RST_CMN_Person('UserName')+'" Required=true> &nbsp;(بالحروف الانجليزية و متوافق مع الاسم الاخير)</Font></TD></tr>')
          else
          ...
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;كلمة السر:</TD>');
          Response.write('	    <TD class="register-td3"><INPUT maxLength=20  title="تأكيد كلمة السر" name=epassword dir=ltr  type=password Value="'+RST_CMN_Person('Password')+'" Required=true></TD></TR>');
          
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;تأكيد كلمة السر:</TD>');
          Response.write('	    <TD class="register-td3"><INPUT maxLength=20  title="تأكيد كلمة السر" name=Password1 type=password dir=ltr  Value="'+RST_CMN_Person('Password')+'"  Required=true></TD></TR>');
          
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;الاسم الأول</TD>');
          if(ErrUserId==1)  S=ReadArg('FName',null); else S=RST_CMN_Person('fName');
          Response.write('	    <TD class="register-td3"><INPUT maxLength=30 title="الاسم الأول"  name=FName size=20   Value="'+S+'"  Required=true LANGUAGE=javascript onkeypress="return FARKeyPress()"></TD>');

          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;الاسم الأخير:</TD>');
          if(ErrUserId==1)  S=ReadArg('LName',null); else S=RST_CMN_Person('lName');
          Response.write('	     <TD class="register-td3"><INPUT maxLength=40 title="الاسم الأخير" name=LName size=20  Value="'+S+'"  Required=true LANGUAGE=javascript onkeypress="return FARKeyPress()"></TD>');
          ...
          Response.write('<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;نوع المستخدم:</TD><TD class="register-td3">');
          ...
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;ضمن المجموعة:</TD><TD class="register-td3">');
	  ...
	  CreateDBCompoBox('GroupID','true',disabled,"Declare @PID as int Select @PID=dbo.fn_CMN_Dfn_GetID (Null , 'Constants\\Groups') SELECT ID , Vlu FROM T_CMN_DFN where PID = @PID ",S,145,0) 	
          ...
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;البلد:</TD><TD class="register-td3">');
          ...
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;المدينة:</TD>');
          if(ErrUserId==1)  S=ReadArg('City',null); else S=RST_CMN_Person('City');
          Response.write('	    <TD class="register-td3"><INPUT maxLength=30 title="المدينة" name=City size=20  Value="'+S+'" Required=true LANGUAGE=javascript onkeypress="return FARKeyPress()"></TR>');

          Response.write('        <TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;المستوى التعليمي:</TD>');
		  ...
		  CreateDBCompoBox('Grade','true','',"Declare @PID as int Select @PID = dbo.fn_CMN_Dfn_GetID (Null , 'Constants\\Grade') SELECT ID , Vlu FROM T_CMN_DFN where PID = @PID",S,145,1,'المستوى التعليمي');
          Response.write('  </TD></TR>');

          Response.write('        <TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;المستوى الحوزوي:</TD>');
          Response.write('          <TD class="register-td3">');
          if (RST_CMN_Person.recordcount!=0) S=RST_CMN_Person("GradeHozavi").Value
          else S=ReadArg('GradeHozavi',null);
		  CreateDBCompoBox('GradeHozavi','true','',"Declare @PID as int Select @PID = dbo.fn_CMN_Dfn_GetID (Null , 'Constants\\GradeHozavi') SELECT ID , Vlu FROM T_CMN_DFN where PID = @PID",S,145,1,'المستوى الحوزوي');
          Response.write('  </TD></TR>');

          Response.write('	<TR><TD class="register-td2">رقم الهاتف:</TD>');
          if(ErrUserId==1)  S=ReadArg('Reshteh',null); else S=RST_CMN_Person('Reshteh');
          Response.write('            <TD class="register-td3"><INPUT maxLength=20 title="رقم الهاتف" name=Reshteh size=20 dir=ltr Value="'+S+'" LANGUAGE=javascript onkeypress="return FARKeyPress()"> </TD></tr>');
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;تاريخ الميلاد:</TD>');
          if(ErrUserId==1)  S=ReadArg('BirthDay',null); else S=RST_CMN_Person('BirthDay');
          Response.write('	    <TD class="register-td3"><INPUT dir=ltr maxLength=8 title="تاريخ الميلاد" name=BirthDay size=20 Value="'+S+'" Required=true></TD></TR>');
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;البريد الإلكتروني:</TD>');
          if(ErrUserId==1)  S=ReadArg('EMail',null); else S=RST_CMN_Person('EMail');
          Response.write('	    <TD class="register-td3"><INPUT maxLength=40 title="البريد الإلكتروني" name=EMail size=20 dir=ltr Value="'+S+'" Required=true>&nbsp;عنوان بريدك الالكتروني الصحيح</TD></TR>');
          Response.write('	<TR><TD class="register-td2"><font color=#f1a664>*</Font>&nbsp;الجنس:</td>');
          Response.write('	    <td class="register-td3">');

          if (RST_CMN_Person.recordcount!=0) S=RST_CMN_Person("Sex").Value
          else S=ReadArg('Sex',null);
		  CreateDBCompoBox('Sex','true','',"Declare @PID as int Select @PID=dbo.fn_CMN_Dfn_GetID (Null , 'Constants\\Sex') SELECT ID , Vlu FROM T_CMN_DFN where PID = @PID",S,145,1,'الجنس');
          ...
          Response.write('</TABLE>');
		  Response.write('<p>&nbsp;</p>');
          Response.write('<p align=center class="register-td4"><input type="submit" value=" دخول " name="B1"></p>');
		...
		<div class="top-header">
					...
					<div class="header-area">
						<table class="header-links">
							<tr>
							<td>
								<span><a href="/default.htm">فارسي</a>&nbsp;</span>
								<span><a href="/Ar/DownLoad/">تحميل البرنامج</a>&nbsp;</span>
								<span><a href="/Ar/Contact/">اتصل بنا</a>&nbsp;</span>
								<span><a href="/Ar/Support/">الدعم المعنوي</a>&nbsp;</span>
								<span><a href="/Ar/News/">جديد الموقع</a>&nbsp;</span>
								<span><a href="javascript:void(0)" onclick="return gotoOldSite()">الاصدار القديم</a></span>
							</td>
							</tr>
						</table>
					</div>
					...
					<tr>
					<td class="messengerlink-td1"><a href="http://eshia.ir/ar/feqh/timing/"><img style="border:0px;outline:0px" src="/Images/Messenger_ar.gif" /></a></td>
...
<!--#include file="BodyClick.Inc"-->	
			...
			<div id="logo"><img src="/Images/Logo_ar.jpg" width="184" height="215" border="0" usemap="#Map" alt='logo' /></div>
			<!--//////////end-Serach\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\-->
			<div class="rightmenu_Ar">
				<ul class="vmenu fixed-menu">
					<li class="nomenu">
						...
						<a href="/Ar/Feqh/Archive/lebanon/" style="font-size:0.7em; text-indent:1.5em !important;">اللبنان</a>
						<hr class="Separator"/>
						...
						<a href="/Aqaed/Archive/" style="font-size:0.7em; text-indent:1.5em !important;">الدروس الکلامية</a>
						...
						<hr class="Separator"/>
						<a href="http://lib.eshia.ir" style="font-size:0.7em; text-indent:1.5em !important;">مکتبة العربية</a>
						<a href="http://lib2.eshia.ir" style="font-size:0.7em; text-indent:1.5em !important;">مکتبة الفارسية</a>
						<a href="http://www.wikifeqh.ir" style="font-size:0.7em; text-indent:1.5em !important;">ويکي الفقه</a>
						<a href="http://www.wikiporsesh.ir" style="font-size:0.7em; text-indent:1.5em !important;">ويکي السوال</a>
	...
	<tr>
		<td colspan="2" id="contentfooter" style="background:url(/Images/Content_Back---down.jpg) repeat-x bottom;height:365px;" valign="bottom" align="center">
			<p><img src="/Images/BaharSound.png" alt='BaharSound' /></p>
			<p>
...
<map name="Map" id="Map">
  <area shape="rect" coords="5,25,177,225" href="/Ar/" alt='map' />
</map>
